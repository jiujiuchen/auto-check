...
<script type="text/javascript">
        ...
        require(
            ...
            function (ec) {
                ...
                var myChart = ec.init(document.getElementById('countDeivce')); 
                	    ...
                	    series : [
                	        {
                	            ...
                	            center: ['40%', '50%'],
                	            data:[
                	                {value:335, name:'Linux'},
                	                {value:310, name:'Aix'},
                	                {value:234, name:'Hp-Ux'},
                	                {value:135, name:'Windows'}
                	            ]
                	        }
                	    ]
                	};
	...
	<div class="conWrap">
		...
		<div class="item">
			...
			<div class="numberTu right">
				...
				<div class="photo" id="countDeivce" style="height:235px;width: 536px;">
